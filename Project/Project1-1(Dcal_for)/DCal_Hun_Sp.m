...
skill_NPM = [
    ...
    {'팔라딘','어차',100,90,83,80,74,69,67,0}
    {'나이트로드','어벤져',95,0,0,0,0,0,0,0}
    {'섀도어','부메랑 스탭',47,0,0,0,0,0,0,0}
    ...
    {'보우마스터','애로우 레인',100,90,83,80,74,0,0,0}
    {'신궁','피어싱',21,21,21,0,0,0,0,0} %차징
...
skill = [
    ...
    {'아크메이지(불,독)','메테오',340,2,15}
    {'비숍','제네시스',420,2,15}
    {'보우마스터','애로우 레인',200,3,6}
    {'신궁','피어싱',250,1,6} 
