...
skill_NPM = [
    ...
    {'팔라딘','블래스트/생츄어리',95,87,0,0,0,0,0,0}
...
skill = [
    ...
    {'나이트로드','트리플스로우',160,5}
    {'섀도어','새비지',200,6}
    {'아크메이지(썬,콜)','체인 라이트닝',640,2}
    {'아크메이지(불,독)','패럴라이징',180,6}
    {'비숍','엔젤레이',350,2}
    {'보우마스터','폭풍의시',240,1}
    {'신궁','스트레이트',140,6}
...
for ii=1:a
    ...
    if strcmp(str,'신궁')
         No_MAX =  No_MAX/1.4; % 다시 원래 값으로 되돌리기
    end
