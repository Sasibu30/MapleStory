...
%=== 입력값(능력치) ===
lv = 1000; %정복자 레벨
ap_premium = 0; %스텍작 횟수(풀)
No_MAX = 20*10^6; %맥뎀 제한 수치
No_MAX0 = 20*10^6; %맥뎀 제한 수치(법격)
...
skill = [
    {'히어로','브랜디쉬',360,2,6} 
    {'다크나이트','폴암 쓰레셔',170,2,6} 
    {'팔라딘','어차',330,1,8} 
    {'나이트로드','어벤져',290,1,6}
    {'섀도어','부메랑 스탭/시브즈',123,1,0}      
    {'아크메이지(썬,콜)','블리자드',720,1,15}%{'아크메이지(썬,콜)','체인 라이트닝',640,2,6}
    {'아크메이지(불,독)','메테오',760,1,15}
    {'비숍','제네시스',790,1,15}
    {'보우마스터','폭풍의시',240,1,1}%{'보우마스터','애로우 레인',100,3,6}
    {'신궁','피어싱',350,1,6} 
    {'바이퍼','드래곤 스트라이크/샤크웨이브',123,1,0}
    {'캡틴','배틀쉽:토르페도',1020,1,6}
    ];
